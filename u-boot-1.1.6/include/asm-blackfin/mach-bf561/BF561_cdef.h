...
#define pSRAM_BASE_ADDR                ((volatile uint32_t *)SRAM_BASE_ADDR)
...
#define pDMEM_CONTROL                  ((volatile uint32_t *)DMEM_CONTROL)
...
#define pSRAM_BASE_ADDR_CORE_A         ((volatile uint32_t *)SRAM_BASE_ADDR_CORE_A)
...
#define pSRAM_BASE_ADDR_CORE_B         ((volatile uint32_t *)SRAM_BASE_ADDR_CORE_B)
...
#define pUART_MSR                      ((volatile uint16_t *)UART_MSR)
...
#define pUART_GBL                      ((volatile uint16_t *)UART_GBL)
...
#define pEBIU_SDBCTL                   ((volatile uint32_t *)EBIU_SDBCTL)
