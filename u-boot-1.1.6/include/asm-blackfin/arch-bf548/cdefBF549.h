...
#define                      pSDH_PWR_CTL ((volatile unsigned long *)SDH_PWR_CTL)
#define                      pSDH_CLK_CTL ((volatile unsigned long *)SDH_CLK_CTL)
#define                     pSDH_ARGUMENT ((volatile unsigned long *)SDH_ARGUMENT)
#define                      pSDH_COMMAND ((volatile unsigned long *)SDH_COMMAND)
#define                     pSDH_RESP_CMD ((volatile unsigned long *)SDH_RESP_CMD)
...
#define                    pSDH_DATA_LGTH ((volatile unsigned long *)SDH_DATA_LGTH)
#define                     pSDH_DATA_CTL ((volatile unsigned long *)SDH_DATA_CTL)
#define                     pSDH_DATA_CNT ((volatile unsigned long *)SDH_DATA_CNT)
#define                       pSDH_STATUS ((volatile unsigned long *)SDH_STATUS)
#define                   pSDH_STATUS_CLR ((volatile unsigned long *)SDH_STATUS_CLR)
#define                        pSDH_MASK0 ((volatile unsigned long *)SDH_MASK0)
#define                        pSDH_MASK1 ((volatile unsigned long *)SDH_MASK1)
#define                     pSDH_FIFO_CNT ((volatile unsigned long *)SDH_FIFO_CNT)
...
#define                        pUSB_FADDR ((void *volatile *)USB_FADDR)
