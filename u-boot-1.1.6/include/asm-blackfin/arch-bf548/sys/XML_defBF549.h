/***************************************************************
*
* $RCSfile: XML_defBF549.h,v $
*
* Description: ADSP-BF549 DEF Header
*              This def header file auto-generated from:
...
*
* $Log: XML_defBF549.h,v
*
***************************************************************/

#ifndef _XML_DEF_BF549_H
#define _XML_DEF_BF549_H

/* XML_defBF54x_base.h contains the set of #defines that are common to all ADSP-BF54x processors */

#include "XML_defBF54x_base.h"
...
#define                HOST_FLUSH  0x10       /* FIFO Flush */
#define               nHOST_FLUSH  0x0       
...
#define                    nBT_EN  0x0       
#define                       HER  0x100      /* Enable Host Read */
#define                      nHER  0x0       
...
#define                     READY  0x1        /* DMA Direction */
#define                    nREADY  0x0       
#define                  FIFOFULL  0x2        /* Transfer Word Size */
#define                 nFIFOFULL  0x0       
#define                 FIFOEMPTY  0x4        /* DMA Mode */
#define                nFIFOEMPTY  0x0       
#define                  COMPLETE  0x8        /* Work Unit Transitions */
#define                 nCOMPLETE  0x0       
#define                      HSHK  0x10       /* Data Interrupt Timing Select */
#define                     nHSHK  0x0       
#define                   TIMEOUT  0x20       /* Data Interrupt Enable */
#define                  nTIMEOUT  0x0       
#define                      HIRQ  0x40       /* Flex Descriptor Size */
#define                     nHIRQ  0x0       
#define                 CNFG_PEND  0x80       /* Next Operation */
#define                nCNFG_PEND  0x0       
#define                   DMA_DIR  0x100      /* DMA Completion Interrupt Status */
#define                  nDMA_DIR  0x0       
#define                       BTE  0x200      /* DMA Error Interrupt Status */
#define                      nBTE  0x0       
...
#define             DMA_ADDR_HIGH  0xffffffff /* polling interval for selected Tx EP */

/* Bit masks for USB_DMAxADDRLOW */

#define              DMA_ADDR_LOW  0xffffffff /* polling interval for selected Tx EP */

/* Bit masks for USB_DMAxCOUNTHIGH */

#define            DMA_COUNT_HIGH  0xffffffff /* polling interval for selected Tx EP */

/* Bit masks for USB_DMAxCOUNTLOW */

#define             DMA_COUNT_LOW  0xff       /* polling interval for selected Tx EP */
