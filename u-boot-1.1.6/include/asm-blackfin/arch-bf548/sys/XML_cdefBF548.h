/***************************************************************
*
* $RCSfile: XML_cdefBF548.h,v $
*
* Description: ADSP-BF548 CDEF Header
*              This cdef header file auto-generated from:
*              "System\ArchDef\XML\ArchDef\ADSP-BF548-proc.xml", Version 1.04
*              "System\ArchDef\XML\ArchDef\ADSP-EDN-BF548-extended.xml", Version 1.04
*              Registers were sorted by ascending MMR address.
*
*              **************************************
...
*
* $Log: XML_cdefBF548.h,v
*
***************************************************************/

#ifndef _XML_CDEF_BF548_H
#define _XML_CDEF_BF548_H

/* XML_cdefBF54x_base.h contains the set of #defines that are common to all ADSP-BF54x processors */

#include <sys/XML_cdefBF54x_base.h>

/* The following are the #defines needed by ADSP-BF548 that are not in the common header */

#include <sys/XML_defBF548.h>
...
#define                        pUART3_DLL ((volatile unsigned char *)UART3_DLL)
#define                        pUART3_DLH ((volatile unsigned char *)UART3_DLH)
#define                       pUART3_GCTL ((volatile unsigned char *)UART3_GCTL)
#define                        pUART3_LCR ((volatile unsigned char *)UART3_LCR)
#define                        pUART3_MCR ((volatile unsigned char *)UART3_MCR)
#define                        pUART3_LSR ((volatile unsigned char *)UART3_LSR)
#define                        pUART3_MSR ((volatile unsigned char *)UART3_MSR)
#define                        pUART3_SCR ((volatile unsigned char *)UART3_SCR)
#define                    pUART3_IER_SET ((volatile unsigned char *)UART3_IER_SET)
#define                  pUART3_IER_CLEAR ((volatile unsigned char *)UART3_IER_CLEAR)
#define                        pUART3_THR ((volatile unsigned char *)UART3_THR)
#define                        pUART3_RBR ((volatile unsigned char *)UART3_RBR)
...
#define                         pSDH_PID0 ((volatile unsigned char *)SDH_PID0)
#define                         pSDH_PID1 ((volatile unsigned char *)SDH_PID1)
#define                         pSDH_PID2 ((volatile unsigned char *)SDH_PID2)
#define                         pSDH_PID3 ((volatile unsigned char *)SDH_PID3)
#define                         pSDH_PID4 ((volatile unsigned char *)SDH_PID4)
#define                         pSDH_PID5 ((volatile unsigned char *)SDH_PID5)
#define                         pSDH_PID6 ((volatile unsigned char *)SDH_PID6)
#define                         pSDH_PID7 ((volatile unsigned char *)SDH_PID7)
...
#define                  pUSB_DMA0ADDRLOW ((void *volatile *)USB_DMA0ADDRLOW)
#define                 pUSB_DMA0ADDRHIGH ((void *volatile *)USB_DMA0ADDRHIGH)
...
#define                  pUSB_DMA1ADDRLOW ((void *volatile *)USB_DMA1ADDRLOW)
#define                 pUSB_DMA1ADDRHIGH ((void *volatile *)USB_DMA1ADDRHIGH)
...
#define                  pUSB_DMA2ADDRLOW ((void *volatile *)USB_DMA2ADDRLOW)
#define                 pUSB_DMA2ADDRHIGH ((void *volatile *)USB_DMA2ADDRHIGH)
...
#define                  pUSB_DMA3ADDRLOW ((void *volatile *)USB_DMA3ADDRLOW)
#define                 pUSB_DMA3ADDRHIGH ((void *volatile *)USB_DMA3ADDRHIGH)
...
#define                  pUSB_DMA4ADDRLOW ((void *volatile *)USB_DMA4ADDRLOW)
#define                 pUSB_DMA4ADDRHIGH ((void *volatile *)USB_DMA4ADDRHIGH)
...
#define                  pUSB_DMA5ADDRLOW ((void *volatile *)USB_DMA5ADDRLOW)
#define                 pUSB_DMA5ADDRHIGH ((void *volatile *)USB_DMA5ADDRHIGH)
...
#define                  pUSB_DMA6ADDRLOW ((void *volatile *)USB_DMA6ADDRLOW)
#define                 pUSB_DMA6ADDRHIGH ((void *volatile *)USB_DMA6ADDRHIGH)
...
#define                  pUSB_DMA7ADDRLOW ((void *volatile *)USB_DMA7ADDRLOW)
#define                 pUSB_DMA7ADDRHIGH ((void *volatile *)USB_DMA7ADDRHIGH)
