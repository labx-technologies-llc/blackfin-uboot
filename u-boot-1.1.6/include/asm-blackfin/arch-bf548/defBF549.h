...
#define                    nBT_EN  0x0       
#define                       EHR  0x100      /* Enable Host Read */
#define                      nEHR  0x0       
#define                       EHW  0x200      /* Enable Host Write */
#define                      nEHW  0x0       
...
#define                START_ADDR  0x1fffffe  /* Asynchronous Packet Receive Buffer Start Address */

/* Bit masks for MXVR_APRB_CURR_ADDR */

#define                 CURR_ADDR  0xffffffff /* Asynchronous Packet Receive Buffer Current Address */

/* Bit masks for MXVR_APTB_START_ADDR */

#define                START_ADDR  0x1fffffe  /* Asynchronous Packet Transmit Buffer Start Address */

/* Bit masks for MXVR_APTB_CURR_ADDR */

#define                 CURR_ADDR  0xffffffff /* Asynchronous Packet Transmit Buffer Current Address */
...
#define                START_ADDR  0x1fffffe  /* Control Message Receive Buffer Start Address */

/* Bit masks for MXVR_CMRB_CURR_ADDR */

#define                 CURR_ADDR  0xffffffff /* Control Message Receive Buffer Current Address */

/* Bit masks for MXVR_CMTB_START_ADDR */

#define                START_ADDR  0x1fffffe  /* Control Message Transmit Buffer Start Address */

/* Bit masks for MXVR_CMTB_CURR_ADDR */

#define                 CURR_ADDR  0xffffffff /* Control Message Transmit Buffer Current Address */

/* Bit masks for MXVR_RRDB_START_ADDR */

#define                START_ADDR  0x1fffffe  /* Remote Read Buffer Start Address */

/* Bit masks for MXVR_RRDB_CURR_ADDR */

#define                 CURR_ADDR  0xffffffff /* Remote Read Buffer Current Address */
