...
static int AFP_NumSectors = 71;
static long AFP_SectorSize2 = 0x10000;
static int AFP_SectorSize1 = 0x2000;
static unsigned long flash_get_size(ulong baseaddr, flash_info_t *info, int bank_flag)
{
	int id = 0, i = 0;
...
unsigned long flash_init(void)
{
	...
	flash_protect(FLAG_PROTECT_SET, CFG_FLASH_BASE, (flash_info[0].start[2] - 1), &flash_info[0]);
...
static int erase_block_flash(int nBlock)
{
...
static void unlock_flash(long ulOffset)
{
...
static void get_sector_number(long ulOffset, int *pnSector)
{
	int nSector = 0;
