...
#ifndef __BFIN_CDEF_ADSP_EDN_BF51x_extended__
#define __BFIN_CDEF_ADSP_EDN_BF51x_extended__
...
#define pSPI0_SHADOW                   ((uint16_t volatile *)SPI0_SHADOW) /* SPI0_RDBR Shadow Register */
#define bfin_read_SPI0_SHADOW()        bfin_read16(SPI0_SHADOW)
#define bfin_write_SPI0_SHADOW(val)    bfin_write16(SPI0_SHADOW, val)
#define pSPI1_CTL                      ((uint16_t volatile *)SPI1_CTL) /* SPI1 Control */
...
#endif /* __BFIN_CDEF_ADSP_EDN_BF51x_extended__ */
